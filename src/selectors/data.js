...
export const interactiveVideosEntitiesSelector = (state) => state.getIn([ 'data', 'entities', 'interactiveVideos' ]);
...
export const listProductLabelsEntitiesSelector = (state) => state.getIn([ 'data', 'entities', 'listProductLabels' ]);
...
export const topCommercialsEntitiesSelector = (state) => state.getIn([ 'data', 'entities', 'topCommercials' ]);
...
export const filterHasInteractiveVideosRelationsSelector = (state) => state.getIn([ 'data', 'relations', 'filterHasInteractiveVideos' ]);
...
export const filterHasProductLabelsRelationsSelector = (state) => state.getIn([ 'data', 'relations', 'filterHasProductLabels' ]);
...
export const filterHasTopCommercialsRelationsSelector = (state) => state.getIn([ 'data', 'relations', 'filterHasTopCommercials' ]);
...
export const searchStringHasDatalabeltypesRelationsSelector = (state) => state.getIn([ 'data', 'relations', 'searchStringHasDatalabeltypes' ]);
...
export const searchStringHasProductLabelsRelationsSelector = (state) => state.getIn([ 'data', 'relations', 'searchStringHasProductLabels' ]);
...
export const mediumHasCropsRelationsSelector = (state) => state.getIn([ 'data', 'relations', 'mediumHasCrops' ]);
...
export const topicHasSpottsRelationsSelector = (state) => state.getIn([ 'data', 'relations', 'topicHasSpotts' ]);
