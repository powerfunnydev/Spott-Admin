...
/**
 * GET /video/processors/{requestId}
 * Get the status of process request, given the requestId retrieved during the
 * postProcess call.
 * @param {string} authenticationToken
 * @param {object} data
 ...
 * Get the logs of a process request, given the requestId retrieved during the
 * postProcess call.
 * @param {string} authenticationToken
 * @param {object} data
 * @param {string} data.requestId The id of the process video request.
