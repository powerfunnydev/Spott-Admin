...
export const PUSH_NOTIFICATION_DELETE_SUCCESS = 'PUSH_NOTIFICATION/PUSH_NOTIFICATION_DELETE_SUCCESS';
export const PUSH_NOTIFICATION_DELETE_ERROR = 'PUSH_NOTIFICATION/PUSH_NOTIFICATION_DELETE_ERROR';

export const PUSH_NOTIFICATIONS_DELETE_START = 'PUSH_NOTIFICATION/PUSH_NOTIFICATIONS_DELETE_START';
export const PUSH_NOTIFICATIONS_DELETE_SUCCESS = 'PUSH_NOTIFICATION/PUSH_NOTIFICATIONS_DELETE_SUCCESS';
export const PUSH_NOTIFICATIONS_DELETE_ERROR = 'PUSH_NOTIFICATION/PUSH_NOTIFICATIONS_DELETE_ERROR';
...
export const PUSH_NOTIFICATION_FETCH_START = 'PUSH_NOTIFICATION/PUSH_NOTIFICATION_FETCH_START';
export const PUSH_NOTIFICATION_FETCH_SUCCESS = 'PUSH_NOTIFICATION/PUSH_NOTIFICATION_FETCH_SUCCESS';
export const PUSH_NOTIFICATION_FETCH_ERROR = 'PUSH_NOTIFICATION/PUSH_NOTIFICATION_FETCH_ERROR';

export const PUSH_NOTIFICATION_PERSIST_START = 'PUSH_NOTIFICATION/PUSH_NOTIFICATION_PERSIST_START';
export const PUSH_NOTIFICATION_PERSIST_SUCCESS = 'PUSH_NOTIFICATION/PUSH_NOTIFICATION_PERSIST_SUCCESS';
...
export const fetchPushNotification = makeApiActionCreator(api.fetchPushNotification, PUSH_NOTIFICATION_FETCH_START, PUSH_NOTIFICATION_FETCH_SUCCESS, PUSH_NOTIFICATION_FETCH_START);
export const persistPushNotification = makeApiActionCreator(api.persistPushNotification, PUSH_NOTIFICATION_PERSIST_START, PUSH_NOTIFICATION_PERSIST_SUCCESS, PUSH_NOTIFICATION_PERSIST_ERROR);
