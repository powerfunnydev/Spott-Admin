...
export const CROPS_DELETE_START = 'CROP/CROPS_DELETE_START';
export const CROPS_DELETE_SUCCESS = 'CROP/CROPS_DELETE_SUCCESS';
export const CROPS_DELETE_ERROR = 'CROP/CROPS_DELETE_ERROR';
...
export const deleteCrops = makeApiActionCreator(api.deleteCrops, CROPS_DELETE_START, CROPS_DELETE_SUCCESS, CROPS_DELETE_ERROR);
