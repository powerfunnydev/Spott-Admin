...
export const fetchBroadcastersEntry = makeApiActionCreator(api.fetchBroadcastersEntry, BROADCASTERS_ENTRY_FETCH_START, BROADCASTERS_ENTRY_FETCH_SUCCESS, BROADCASTERS_ENTRY_FETCH_ERROR);
export const persistBroadcastersEntry = makeApiActionCreator(api.persistBroadcasters, BROADCASTERS_ENTRY_PERSIST_START, BROADCASTERS_ENTRY_PERSIST_SUCCESS, BROADCASTERS_ENTRY_PERSIST_ERROR);
export const deleteBroadcastersEntries = makeApiActionCreator(api.deleteBroadcastersEntries, BROADCASTERS_ENTRIES_DELETE_START, BROADCASTERS_ENTRIES_DELETE_SUCCESS, BROADCASTERS_ENTRIES_DELETE_ERROR);
export const deleteBroadcastersEntry = makeApiActionCreator(api.deleteBroadcastersEntry, BROADCASTERS_ENTRY_DELETE_START, BROADCASTERS_ENTRY_DELETE_SUCCESS, BROADCASTERS_ENTRY_DELETE_ERROR);
