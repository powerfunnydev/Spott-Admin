...
export const persistBroadcastChannelsEntry = makeApiActionCreator(broadcastChannelApi.persistBroadcastChannel, BROADCAST_CHANNELS_ENTRY_PERSIST_START, BROADCAST_CHANNELS_ENTRY_PERSIST_SUCCESS, BROADCAST_CHANNELS_ENTRY_PERSIST_ERROR);
