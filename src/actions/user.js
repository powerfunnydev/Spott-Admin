...
export const USERS_DELETE_START = 'USERS/USERS_DELETE_START';
...
export const deleteUsers = makeApiActionCreator(api.deleteUsers, USERS_DELETE_START, USERS_DELETE_SUCCESS, USERS_DELETE_ERROR);
