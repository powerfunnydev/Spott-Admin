...
export default class Users extends Component {
  ...
  async onDeleteLinkUser (userId) {
    await this.props.deleteLinkUser(this.props.params.brandId, userId);
  ...
  onClickNewEntry (e) {
    e.preventDefault();
    this.props.routerPushWithReturnTo(`/content/brands/read/${this.props.params.brandId}/link/user`);
  }
  ...
  async onClickDeleteSelected () {
    ...
    await this.props.deleteLinkUsers(this.props.params.brandId, userIds);
    await this.props.load(this.props.location.query, this.props.params.brandId);
  }
          ...
          <div style={[ generalStyles.paddingTable, generalStyles.paddingLeftAndRight ]}>
            ...
            {usersDisplay === 'grid' &&
              <div style={generalStyles.row}>
                ...
                <Tile key='createBrand' onCreate={this.onClickNewEntry}/>
              </div>
            }
          </div>
        </div>
