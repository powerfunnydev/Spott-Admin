...
@Radium
export default class CreateMovieModal extends Component {
  ...
  render () {
    ...
    return (
      <PersistModal isOpen title='Create Movie' onClose={this.onCloseClick} onSubmit={handleSubmit(this.submit)}>
