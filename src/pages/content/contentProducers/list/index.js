...
export default class ContentProducers extends Component {
  ...
  determineReadUrl (contentProducer) {
    return `/content/content-producers/read/${contentProducer.get('id')}`;
  }

  determineEditUrl (contentProducer) {
    return `/content/content-producers/edit/${contentProducer.get('id')}`;
  }
  ...
  render () {
    const { contentProducers, children, deleteContentProducer, isSelected, location: { query, query: { display, page, searchString, sortField, sortDirection } },
            ...
            <Container style={generalStyles.paddingTable}>
              ...
              {(display === undefined || display === 'list') &&
                <div>
                  <ListView
                    columns={columns}
                    data={contentProducers}
                    deleteItem={deleteContentProducer}
