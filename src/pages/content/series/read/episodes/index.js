              ...
              <div>
                <Table style={generalStyles.lightGrayBorder}>
                  <Headers>
                    ...
                    <CustomCel style={[ headerStyles.header, headerStyles.notFirstHeader, { flex: 5 } ]}>SEASON TITLE</CustomCel>
                    <CustomCel sortColumn={this.props.onSortField.bind(this, 'SEASON_NUMBER')} sortDirection = {episodesSortField === 'SEASON_NUMBER' ? sortDirections[episodesSortDirection] : NONE} style={[ headerStyles.header, headerStyles.notFirstHeader, headerStyles.clickableHeader, { minWidth: 100 } ]}>SEASON #</CustomCel>
                    <CustomCel style={[ headerStyles.header, headerStyles.notFirstHeader, { minWidth: 130 } ]}>PUBLISH STATUS</CustomCel>
                    <CustomCel style={[ headerStyles.header, headerStyles.notFirstHeader, { flex: 3 } ]}>UPDATED BY</CustomCel>
                    <CustomCel style={[ headerStyles.header, headerStyles.notFirstHeader, { flex: 3 } ]}>LAST UPDATED ON</CustomCel>
