...
@Radium
export default class CreateShopModal extends Component {
  ...
  render () {
    ...
    return (
      <PersistModal createAnother isOpen title='Create Shop' onClose={this.onCloseClick} onSubmit={handleSubmit(this.submit)}>
