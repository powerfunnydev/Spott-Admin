...
export default class CreateSpottModal extends Component {
  ...
  render () {
    const { handleSubmit, localeNames, searchedTopicIds, searchTopics, topicsById } = this.props;
    return (
      <PersistModal createAnother isOpen title='Add Spott' onClose={this.onCloseClick} onSubmit={handleSubmit(this.submit)}>
