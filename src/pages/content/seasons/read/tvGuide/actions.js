...
export const TV_GUIDE_ENTRIES_FETCH_ERROR = 'SEASON_READ_TV_GUIDE/TV_GUIDE_FETCH_ERROR';

export const TV_GUIDE_ENTRIES_DELETE_ERROR = 'SEASON_READ_TV_GUIDE/TV_GUIDE_ENTRIES_REMOVE_ERROR';
export const TV_GUIDE_ENTRY_DELETE_ERROR = 'SEASON_READ_TV_GUIDE/TV_GUIDE_ENTRY_REMOVE_ERROR';

export const SELECT_ALL_CHECKBOXES = 'SEASON_READ_TV_GUIDE/SELECT_ALL_CHECKBOXES';
export const SELECT_CHECKBOX = 'SEASON_READ_TV_GUIDE/SELECT_CHECKBOX';
export const SELECT_ENTITY = 'SEASON_READ_TV_GUIDE/SELECT_ENTITY';

export const SORT_COLUMN = 'SEASON_READ_TV_GUIDE/SORT_COLUMN';
