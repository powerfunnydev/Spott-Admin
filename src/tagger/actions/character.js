...
export const MEDIUM_CHARACTERS_FETCH_START = 'CHARACTER/MEDIUM_CHARACTERS_FETCH_START';
export const MEDIUM_CHARACTERS_FETCH_SUCCESS = 'CHARACTER/MEDIUM_CHARACTERS_FETCH_SUCCESS';
export const MEDIUM_CHARACTERS_FETCH_ERROR = 'CHARACTER/MEDIUM_CHARACTERS_FETCH_ERROR';
...
export const fetchMediumCharacters = makeApiActionCreator(characterApi.getMediumCharacters, MEDIUM_CHARACTERS_FETCH_START, MEDIUM_CHARACTERS_FETCH_SUCCESS, MEDIUM_CHARACTERS_FETCH_ERROR);
