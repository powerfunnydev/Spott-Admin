...
export const MEDIUM_BRANDS_SEARCH_ERROR = 'COLLECTIIONS/MEDIUM_BRANDS_SEARCH_ERROR';
export const MEDIUM_CHARACTERS_SEARCH_ERROR = 'COLLECTIIONS/MEDIUM_CHARACTERS_SEARCH_ERROR';
